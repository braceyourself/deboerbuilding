<section id="testimonials" {{ $attributes }}>
    ...
    <div id="default-carousel" class="relative w-full" data-carousel="static">
        ...
        <button type="button"
                ...
                data-carousel-prev>
                <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-secondary/30 dark:bg-secondary-800/30 group-hover:bg-primary-500 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
